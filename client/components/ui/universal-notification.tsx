...
export interface UniversalNotificationProps {
  title: string;
  description: string;
...
export default function UniversalNotification({
  title,
  description,
  variant = "success",
  onDismiss,
  ...
  // Desktop layout: uses document flow to push content down
  if (isDesktop) {
    return (
      <div
        style={{

...
export const MiniChart: React.FC<MiniChartProps> = ({
  ...
  const chartVariations = {
    default: {
      ...
      markerPosition: { left: "76px", top: "12px" },
    },
    variant1: {
      ...
      markerPosition: { left: "82px", top: "18px" },
    },
    variant2: {
      ...
      markerPosition: { left: "85px", top: "28px" },
    },
    variant3: {
      ...
      markerPosition: { left: "79px", top: "8px" },
    },
  };

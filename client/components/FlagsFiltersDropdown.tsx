...
interface FlagsFiltersDropdownProps {
  isOpen: boolean;
  onClose: () => void;
...
export const FlagsFiltersDropdown: React.FC<FlagsFiltersDropdownProps> = ({
  isOpen,
  onClose,
  triggerRef,
  selectedOptions,
  ...
  // Flags options as specified
  const flagsOptions = [
    { value: "derogatory-information", label: "Derogatory Information" },
    { value: "alert", label: "Alert" },
    { value: "archive", label: "Archive" },
    { value: "drug-test", label: "Drug Test" },
    { value: "monitoring", label: "Monitoring" },
    { value: "rescreening", label: "Rescreening" },
    { value: "adverse-action-notice", label: "Adverse Action Notice" },
    { value: "pre-adverse-action-notice", label: "Pre-Adverse Action Notice" },
    { value: "client-activation-queue", label: "Client Activation Queue" },
  ];

...
export default function InviteNewMember() {
  ...
  const cityOptions = useMemo(() => {
    const options = CITY_OPTIONS_BY_STATE[formData.state];
    if (options && options.length > 0) {
      return options;
    }
    return CITY_OPTIONS_BY_STATE["Select"];
  }, [formData.state]);
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "1 / span 1", gridColumn: "2 / span 1" }
                        : {}
                    }
                  >
                    <label
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "2 / span 1", gridColumn: "2 / span 1" }
                        : {}
                    }
                  >
                    <label
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "3 / span 1", gridColumn: "2 / span 1" }
                        : {}
                    }
                  >
                    <label
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "4 / span 1", gridColumn: "1 / span 1" }
                        : {}
                    }
                  >
                    <label
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "4 / span 1", gridColumn: "2 / span 1" }
                        : {}
                    }
                  >
                    <label
...
>
                  ...
                  <div
                    style={
                      isDesktop
                        ? { gridRow: "5 / span 1", gridColumn: "2 / span 1" }
                        : {}
                    }
                  >
                    <label

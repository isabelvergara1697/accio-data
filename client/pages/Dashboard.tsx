...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Mobile Header Bar */}
        <div className="lg:hidden bg-background border-b border-border px-4 py-3 flex items-center justify-between w-full">
          <button
        ...
        >
          ...
          >
            ...
            <p style={{ margin: 0 }}>
              ...
              on the left and main content flowing correctly.
            </p>
          </div>
        </div>
      </main>

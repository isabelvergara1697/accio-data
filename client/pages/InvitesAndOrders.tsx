                      ...
                      >
                        {(isDesktop || isTablet) && !isMobile ? (
                          <>
                            ...
                            {/* Desktop: Orders Filters Button with X - when orders filters are open */}
                            {showOrdersFiltersModal && (
                              <button
                                onClick={() => setShowOrdersFiltersModal(false)}
                                onMouseEnter={() =>
                                  setHoveredButton("close-orders-filters")
                                }
                                onMouseLeave={() => setHoveredButton(null)}
                                style={{
                                  display: "flex",
                                ...
                                <button
                                  ...
                                  style={{
                                    ...
                                    border:
                                      ...
                                      (activeTab === "orders" && hasAppliedOrdersFilters() && !showOrdersFiltersModal)
                                        ? "1px solid #34479A"
                                        : "1px solid #D5D7DA",
                                    background:
                                      (activeTab === "invites" && hasAppliedFilters() && !showFiltersModal) ||
                                      (activeTab === "orders" && hasAppliedOrdersFilters() && !showOrdersFiltersModal)
                                        ...
                                        : hoveredButton === "filters" ||
                                            ...
                                            (activeTab === "orders" && showOrdersFiltersModal)
                                          ? "#F5F5F5"
                                          : "#FFF",
                                    boxShadow:
                                      "0 0 0 1px rgba(10, 13, 18, 0.18) inset, 0 -2px 0 0 rgba(10, 13, 18, 0.05) inset, 0 1px 2px 0 rgba(10, 13, 18, 0.05)",
                                    ...
                                    background:
                                      ...
                                      (activeTab === "orders" && hasAppliedOrdersFilters() && !showMobileOrdersFiltersModal)
                                        ...
                                        : hoveredButton === "filters" ||
                                            ...
                                            (activeTab === "orders" && showMobileOrdersFiltersModal)
                                          ? "#FDFDFD"
                                          : "#FFF",
                                    width: "100%",
                                    boxShadow:

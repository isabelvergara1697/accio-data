...
const InvitesAndOrders: React.FC = () => {
  ...
  const ordersData: OrderData[] = [
    ...
    },
    {
      ...
      activated: true,
      ews: false,
      packageType: "Executive Standard",
    },
  ];

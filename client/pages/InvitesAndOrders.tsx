  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Tablet Header - Only visible on tablet */}
          {isTablet && (
            <div
              style={{
                display: "flex",
                  ...
                  >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path
                        ...
                        stroke={tableView === "table" ? "#6366F1" : "#A4A7AE"}
                        strokeWidth="1.67"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                  ...
                  >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path
                        ...
                        stroke={tableView === "rows" ? "#6366F1" : "#A4A7AE"}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
          ...
          >
            <div
              style={{
                display: "flex",
                padding: isMobile ? "0 16px" : isTablet ? "0 32px" : "0 32px",
                flexDirection: "column",
                alignItems: "flex-start",
                gap: "20px",
                flex: "1 0 0",
